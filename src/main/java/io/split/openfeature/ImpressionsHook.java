...
public class ImpressionsHook<T> extends Hook<T> {
    // *** I do not think this class is necessary anymore.Impressions are sent automatically through the Split SDK
    // so there is no reason we need to specify a hook for the client to call.
    // Keeping it commented instead of deleted until certain***
